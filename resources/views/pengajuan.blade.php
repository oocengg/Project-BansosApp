            ...
            <form>
                ...
                <div class="form-row" style="display: flex; padding-bottom: 20px">
                    <div class="form-group col-md-6" style="padding-right: 10px">
                        ...
                        <input type="text" class="form-control" id="contoh1" placeholder="Masukkan Nama Lengkap">
                    </div>
                    <div class="form-group col-md-6" style="padding-right: 10px">
                        <label for="contoh2">NIK</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan NIK">
                    </div>
                </div>
                ...
                <div class="form-row" style="display: flex; padding-bottom: 20px">
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        ...
                        <input type="text" class="form-control" id="contoh1" placeholder="Masukkan Tempat Lahir">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">Tanggal Lahir</label>
                        <input type="date" class="form-control" id="contoh2" placeholder="Masukkan Tanggal Lahir">
                    </div>
                    <div class="form-group col-md-6" style="padding-right: 10px">
                        <label for="contoh2">No KK</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan No KK">
                    </div>
                </div>
                ...
                <div class="form-row" style="display: flex; padding-bottom: 20px">
                    ...
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        ...
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan No HP">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">Pekerjaan</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan Pekerjaan">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">Penghasilan</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan Penghasilan">
                    </div>
                </div>
                ...
                <div class="form-row" style="display: flex; padding-bottom: 20px">
                    <div class="form-group col-md-6" style="padding-right: 10px">
                        ...
                        <input type="text" class="form-control" id="contoh1" placeholder="Masukkan Alamat Lengkap">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">Provinsi</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan Provinsi">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">Kabupaten</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan Kabupaten">
                    </div>
                </div>
                ...
                <div class="form-row" style="display: flex; padding-bottom: 20px">
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        ...
                        <input type="text" class="form-control" id="contoh1" placeholder="Masukkan Kecamatan">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">Kelurahan</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan Kelurahan">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">RT</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan RT">
                    </div>
                    <div class="form-group col-md-3" style="padding-right: 10px">
                        <label for="contoh2">RW</label>
                        <input type="text" class="form-control" id="contoh2" placeholder="Masukkan RW">
                    </div>
                </div>
                ...
                <div class="table-responsive col-md-12">
                    <div class="form-group col-md-6" style="padding-right: 10px">
                        ...
                        <select class="form-select" aria-label="Default select example">
                            ...
                            <option value="4">Bantuan Iuran Jaminan Kesehatan Nasional Kartu Indonesia Sehat (PBIN)</option>
